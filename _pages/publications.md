...
document.addEventListener('DOMContentLoaded', function () {
    const data = [
        ...
        { year: 2026, papers: 6, citations: 107 }
    ];
...
> This paper was selected in the collection of review articles on applied physics entitled ["APEX-NEXT" (Noteworthy Excellent Topics)](https://iopscience.iop.org/collections/apex-250923-01).
