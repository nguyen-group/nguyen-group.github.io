...
document.addEventListener('DOMContentLoaded', function () {
    const data = [
        ...
        { year: 2025, papers: 4, citations: 160 }
    ];
    ...
    Highcharts.chart('container', {
        chart: { zoomType: 'xy' },
        title: { text: 'Total Citations: 1,480 &  H-index: 18 (Scopus)' },
...
{:start="68"}
### 2025
64. N. Muhammad, W. Mu, **N. T. Hung**\*, T. Yang\* and D. Zejun\*, [Highly in-plane anisotropic 2D-ZrGeTe4: A promising thermoelectric material with high power factor](https://doi.org/10.1021/acsaem.5c00023), ***ACS Appl. Energy Mater.*** accepted (2025).
