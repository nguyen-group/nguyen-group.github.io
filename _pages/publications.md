...
document.addEventListener('DOMContentLoaded', function () {
    const data = [
        ...
        { year: 2025, papers: 11, citations: 298 }
    ];
    ...
    Highcharts.chart('container', {
        chart: { zoomType: 'xy' },
        title: { text: 'Total Citations: 1,623 &  H-index: 19 (Scopus)' },
...
70. R. Okabe\*, M. Cheng, A. Chotrattanapituk, M. Mandal, D. C. Carrizales, **N. T. Hung**, X. Fu, B. Han, Y. Wang, W. Xie, R.
