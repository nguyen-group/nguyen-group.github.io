...
document.addEventListener('DOMContentLoaded', function () {
    const data = [
        ...
        { year: 2025, papers: 12, citations: 345 }
    ];
    ...
    Highcharts.chart('container', {
        chart: { zoomType: 'xy' },
        title: { text: 'Total Citations: 1,667 &  H-index: 19 (Scopus)' },
...
{:start="73"}
### 2025
72. **N. T. Hung**\*, V. V. Thanh\*, M. Li and T. Shimada, [Strain effect on optical properties and quantum weight of 2D magnetic topological insulators MnBi2X4 (X = Te, Se, S)](https://doi.org/10.48550/arXiv.2504.10879), ***arXiv:2504.10879*** accepted (2025).
