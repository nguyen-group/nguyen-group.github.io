...
document.addEventListener('DOMContentLoaded', function () {
    const data = [
        ...
        { year: 2025, papers: 4, citations: 121 }
    ];
    ...
    Highcharts.chart('container', {
        chart: { zoomType: 'xy' },
        title: { text: 'Total Citations: 1,441 &  H-index: 18 (Scopus)' },
        ...
        series: [
            { name: 'Papers', type: 'column', data: seriesData('papers'), color: 'gray' },
            { name: 'Citations', type: 'line', data: seriesData('citations'), yAxis: 1, marker: { enabled: true }, color: 'green', lineWidth: 2 }
        ]
    });
});
</script>
