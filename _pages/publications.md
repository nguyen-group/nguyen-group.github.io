...
### 2024
55. M. Mandal\*, A. Chotrattanapituk, K. Woller, L. Wu, H. Xu, **N. T. Hung**, N. Mao, R. Okabe, A. Boonkird, T. Nguyen, N. C. Drucker, X. M. Chen, T. Momiki, J. Li, J. Kong, Y. Zhu\* and M. Li\*, [Precise Fermi level engineering in a topological Weyl semimetal via fast ion implantation](https://doi.org/xxx), ***Appl. Phys. Rev.*** accepted (2024).
54. H. L. Liu\*, H. W. Chen, **N. T. Hung**, Y. C. Chen, H. J. Liu, C. T. Chen, Y. L. Chueh, Y. H. Chu, and R. Saito,[Temperature-dependent indirect gaps for two-dimensional bismuth oxychalcogenides probed by spectroscopic ellipsometry](https://doi.org/10.1088/2053-1583/ad50ad), ***2D Mater.*** accepted (2024).
