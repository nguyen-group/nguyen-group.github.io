...
document.addEventListener('DOMContentLoaded', function () {
    const data = [
        ...
        { year: 2026, papers: 9, citations: 237 }
    ];
...
{:start="84"}
### 2026
82. T. T. Mai, M. Altvater, V. Labuntsov, S. Krylyuk, A. Davydov, M. A. Susner, **N. T. Hung**, J. Lynch, D. Jariwala, M. Snure, R. Saito, V. Perebeinos, N. R. Glavin and Rahul Rao\*, [Thickness-dependent surface phonon polaritons in InSe](https://doi.org/...),  ***Matter & Light*** 1, 100014-1-9 (2026).
