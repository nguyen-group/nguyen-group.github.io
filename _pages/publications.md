...
document.addEventListener('DOMContentLoaded', function () {
    const data = [
        ...
        { year: 2025, papers: 11, citations: 287 }
    ];
    ...
    Highcharts.chart('container', {
        chart: { zoomType: 'xy' },
        title: { text: 'Total Citations: 1,611 &  H-index: 19 (Scopus)' },
...
{:start="72"}
### 2025
68. N. V. Thanh, **N. T. Hung**, H. Takehara, A. Taguchi, H. Yi, P. S. Fernandez, H. Ago, P. Yang, L. J. Li, K. Lizarraga, R. Saito and H. L. Liu\*, [Thickness-dependent excitonic properties of hexagonal boron-nitride thin films](https://doi.org/xxx), ***Phys. Rev. Mater.*** accepted (2025).
...
66. V. V. Thanh\* and **N. T. Hung**\*, [Strain effect on Rashba splitting and phonon scattering to improve thermoelectric performance of 2D heterobilayer MoTe2/PtS2](https://doi.org/10.1021/acsaem.5c01254), ***ACS Appl. Energy Mater.*** 8, 9617-9626 (2025). 
